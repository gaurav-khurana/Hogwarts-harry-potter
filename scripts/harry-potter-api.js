...
// const buttonGryffindor = document.querySelector('button-gryffindor');
// const buttonSlytherin = document.querySelector('button-slytherin');
// const buttonRavenclaw = document.querySelector('button-ravenclaw');
// const buttonHufflepuff = document.querySelector('button-hufflepuff');
// const buttonSpell = document.querySelector('button-spell');
// const buttonPotion = document.querySelector('button-potion');
